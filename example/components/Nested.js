...
class Inner extends Component {
  ...
  appendText() {
    this.setState({multi: this.state.multi + 1})
  }

  render() {
    return <Minimap contain>
      <div style={{padding: '0 20px'}}>
        <p>
          <button onClick={this.appendText}>Append more text</button>
        </p>

        {[...Array(this.state.multi).keys()].map((i) => <div key={i}>
          <p>
